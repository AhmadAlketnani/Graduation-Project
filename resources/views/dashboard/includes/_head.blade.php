...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{asset('dashboard-assets/vendor/css/core-dark.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{asset('dashboard-assets/vendor/css/theme-default-dark.css') }}" class="template-customizer-theme-css"/>
