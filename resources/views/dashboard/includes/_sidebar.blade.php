<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
    ...
    <div class="app-brand demo ">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">Injaz</span>
        </a>
    ...
    <ul class="menu-inner py-1 ps ps--active-y">
        ...
        <div class="ps__rail-x" style="left: 0px; bottom: -553px;">
            <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
        </div>
        <div class="ps__rail-y" style="top: 553px; height: 657px; right: 4px;">
            <div class="ps__thumb-y" tabindex="0" style="top: 173px; height: 205px;"></div>
        </div>
    </ul>
</aside>
