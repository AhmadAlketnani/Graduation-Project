        ...
        <div class="row">
            ...
            <form method="post" action="{{ route('stores.store') }}">
                ...
                <div class="form-group mb-3">
                        ...
                        <input class="form-control"  type="text"  placeholder="Page Name" value="{{ old('name') }}" name="name">
                </div>
                <div class="form-group mb-3">
                        <label class="form-label" >Email</label>
                        <input class="form-control"  type="email"  placeholder="Store Email" value="{{ old('email') }}" name="email">
                </div>
                <div class="form-group mb-3">
                        <label class="form-label" >Phone</label>
                        <input class="form-control"  type="number"  placeholder="Store Phone" value="{{ old('phone') }}" name="phone">
                </div>
                <div class="form-group mb-3">
                        <label class="form-label" >Location</label>
                        <input class="form-control"  type="text"  placeholder="Gaza , omar almkhtar" value="{{ old('location') }}" name="location">
                </div>
                <div class="form-group mb-3">
                        <label class="form-label" >Facebook</label>
                        <input class="form-control"  type="url"  placeholder="Facebook URl" value="{{ old('facebook') }}" name="facebook">
                </div>
                <div class="form-group mb-3">
                        <label class="form-label" >instagram</label>
                        <input class="form-control"  type="url"  placeholder="instagram URl" value="{{ old('instagram') }}" name="instagram">
                </div>
